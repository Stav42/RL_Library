...
class Simulation:
    ...
    def train(self, seed=1):
        ...
        for update in range(1, num_upd+1):
            ...
            print(f"Time after sampling: {new_time}")
            print(f"Difference: {new_time-update_start}")
            global_time+=difference
            global_step_list.append(global_step)
            global_time_list.append(global_time)
            print(f"rollout steps: {global_step} time taken overall {global_time} time taken per step: {global_time/global_step}")
